...
class MainMenuActivity : AppCompatActivity() {
    ...
    private fun setupButtonListeners() {
        ...
        findViewById<Button>(R.id.button_aritmatika).setOnClickListener {
            val intent = Intent(this, AritmatikaActivity::class.java)
            startActivity(intent)
        }

        findViewById<Button>(R.id.button_ganjil_genap).setOnClickListener {
            val intent = Intent(this, GanjilGenapActivity::class.java)
            startActivity(intent)
        }
